...
Original file is located at
    https://colab.research.google.com/drive/1amz8cBk2_MbAmSNPCiN1gB6IjVfWTNez
...
sales_df = pd.read_csv('/content/drive/My Drive/Colab Notebooks/Marketing AI/sales_data_sample.csv', encoding = 'unicode_escape')
...
autoencoder.save_weights('autoencoder_1.weights.h5') # Update filename to end in .weights.h5
